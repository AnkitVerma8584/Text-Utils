...
function MyNavBar(props){
  let navItemStyle = `nav-link ${(isActive, isPending) => isPending ? "pending" : isActive ? "active" : ""}`;
  return (
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                  <NavLink className={navItemStyle} aria-current="page" to="/">Home</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink className={navItemStyle} to="/about">About</NavLink>
                </li>
                <li className="nav-item">
                  <NavLink className={navItemStyle} to='/contact'>Contact</NavLink>
                </li>
              </ul>
